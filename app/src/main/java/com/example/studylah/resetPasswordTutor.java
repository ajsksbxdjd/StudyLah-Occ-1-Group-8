...
public class resetPasswordTutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_password_tutor);
    ...
    private void updatePasswordInDatabase(String username, String hashedPassword, resetPasswordTutor.UpdateCallback callback) {
    ...
    private void navigateToLogin() {
        Intent intent = new Intent(resetPasswordTutor.this, LoginTutor.class);
