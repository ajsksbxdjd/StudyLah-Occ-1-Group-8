...
public class forgotPasswordTutor extends AppCompatActivity {
    ...
    public void sendVerifyEmail() {
        ...
        String fetchAllUrl = "https://apex.oracle.com/pls/apex/wia2001_database_oracle/tutor/users"; // Your backend endpoint
        ...
        JsonObjectRequest fetchAllRequest = new JsonObjectRequest(Request.Method.GET, fetchAllUrl, null, response -> {
            try {
                ...
                for (int i = 0; i < itemsArray.length(); i++) {
                    JSONObject tutor = itemsArray.getJSONObject(i);
                    String emailInDatabase = tutor.getString("email");

                    if (emailAddress.equals(emailInDatabase)) {
                        emailExists = true;
                        username = tutor.getString("username"); // Retrieve the username
                        break;
                    }
                }

                if (!emailExists) {
                    Toast.makeText(forgotPasswordTutor.this, "Email does not exist in our records.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(forgotPasswordTutor.this, "Error parsing response. Try again.", Toast.LENGTH_SHORT).show();
                Log.e("ResponseError", e.toString());
            }
        }, error -> {
            String errorMessage = "Failed to fetch tutor data. ";
            ...
            Toast.makeText(forgotPasswordTutor.this, errorMessage, Toast.LENGTH_SHORT).show();
    ...
    private void sendVerificationEmail(String emailAddress) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
            ...
            Toast.makeText(forgotPasswordTutor.this, "Email sent successfully!", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(forgotPasswordTutor.this, errorMessage, Toast.LENGTH_LONG).show();
        }) {
            @Override
    ...
    private void showCodeVerificationDialog() {
        ...
        builder.setPositiveButton("Verify", (dialog, which) -> {
            ...
            if (!enteredCode.isEmpty() && enteredCode.equals(String.valueOf(verificationCode))) {
                ...
                Intent intent = new Intent(forgotPasswordTutor.this, resetPasswordTutor.class);
