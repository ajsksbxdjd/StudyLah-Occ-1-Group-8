...
public class Market_UploadItemStudent extends FragmentActivity implements OnMapReadyCallback {
    ...
    private class ItemDetailsTask extends AsyncTask<Void, Void, String> {
        protected String doInBackground(Void... params) {
            String result = "";
            try {
                URL url = new URL("https://apex.oracle.com/pls/apex/wia2001_database_oracle/student/users");
                ...
                try {
                    ...
                    for (int i = 0; i < items.length(); i++) {
                        ...
                        if (student_username.equals(item.getString("username"))) {
                            ...
                            student_email = item.getString("email");
                             break;
                        }
                    }
                } catch (Exception e) {
    ...
    private void uploadItem() {
        ...
        try {
            ...
            jsonBody.put("seller_display_name", student_name);
            jsonBody.put("seller_email", student_email);
