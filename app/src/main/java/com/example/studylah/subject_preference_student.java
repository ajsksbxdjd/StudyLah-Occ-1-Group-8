...
public class subject_preference_student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subject_preference_student);
                    ...
                    response -> {
                        try {
                            ...
                            if ("success".equals(status)) {
                                ...
                                Intent intent = new Intent(subject_preference_student.this, MainActivity.class);
