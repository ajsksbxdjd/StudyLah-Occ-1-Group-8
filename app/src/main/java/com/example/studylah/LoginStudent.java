...
public class LoginStudent extends AppCompatActivity {
    ...
    private void handleLogin() {
        ...
        if (emailInput.isEmpty() || passwordInput.isEmpty()) {
            Toast.makeText(LoginStudent.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        new LoginTask(emailInput, hashedPassword).execute();
    }
    ...
    private class LoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                ...
                String baseUrl = "https://apex.oracle.com/pls/apex/wia2001_database_oracle/student/users";
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (result == null || result.isEmpty()) {
                    Toast.makeText(LoginStudent.this, "Empty response from server", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (items.length() > 0) {
                    ...
                    if (!userFound) {
                        Toast.makeText(LoginStudent.this, "Invalid email or password", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(LoginStudent.this, "No user found with this email", Toast.LENGTH_LONG).show();
                }
            } catch (JSONException e) {
                Log.e("JSON Parsing Error", e.getMessage(), e);
                Toast.makeText(LoginStudent.this, "Error parsing response", Toast.LENGTH_LONG).show();
            }
        }
    }
}